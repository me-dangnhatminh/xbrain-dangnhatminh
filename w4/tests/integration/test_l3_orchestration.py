"""
Integration tests for L3 tool orchestration.
"""
...
class TestL3Orchestration:
    """Test L3 orchestration with tools."""
    ...
    def test_l3_processing_without_tool_executor_raises_error(self):
        """Test that L3 processing without tool executor raises error."""
        mock_rag = Mock(spec=RAGPipeline)
        ...
        with pytest.raises(ValueError, match="ToolOrchestrator not initialized"):
